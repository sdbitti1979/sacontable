        ...
        $(document).ready(function($) {
            ...
            $("#cuentaPadre").autocomplete({
                ...
                source: function(request, response) {
                    ...
                    $.ajax({
                        url: baseUrl + "index.php/lugaresfisicos/" + seteaListado($(
                            "#tipoSectorAdd").val()) + "/lugaresFisicos/" + request.term,
                        dataType: "json",
                ...
                search: function(event, ui) {
                    $("#cuentaPadreId").val("");
                    const baseUrl = 'http://localhost:82/sacontable/public/';
                    $(this).autocomplete("option", "source", baseUrl + "index.php/lugaresfisicos/" +
                        seteaListado($("#tipoSectorAdd").val()) + "/lugaresFisicos/" + $(
                            "#solicitanteAdd").val());
                },
                minLength: 0,
