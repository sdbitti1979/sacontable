...
@section('script')
    ...
    <script>
        datepicker = flatpickr("#fechaasiento", {
            locale: "es",
            autoclose: true,
            dateFormat: "d/m/Y"
        });
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="datetimepicker">Nombre</label>
                            <input type="text" id="nombre" name="nombre" class="form-control" >
                        </div>
                        <div class="mb-3">
                            <label for="descripcionAsiento" class="form-label">Código</label>
                            <textarea class="form-control" id="codigo" name="codigo"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="descripcionAsiento" class="form-label">Clasificación</label>
