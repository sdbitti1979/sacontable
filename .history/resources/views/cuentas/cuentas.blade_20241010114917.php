    ...
    <div class="container-fluid px-3 px-md-5 pt-4">
        <ul class="nav nav-tabs" id="mainTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="plan-cuentas-tab" data-bs-toggle="tab" data-bs-target="#plan-cuentas" type="button" role="tab" aria-controls="plan-cuentas" aria-selected="true" onclick="inicializarDataTableActivas()">Cuentas Activas</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="plan-cuentas-inactivas-tab" data-bs-toggle="tab" data-bs-target="#plan-cuentas-inactivas" type="button" role="tab" aria-controls="otra-seccion" aria-selected="false" onclick="inicializarDataTableInactivas()">Cuentas Eliminadas</button>
            </li>
        ...
        <div class="tab-content" id="mainTabsContent">
            ...
            <div class="tab-pane fade show" id="plan-cuentas-inactivas" role="tabpanel" aria-labelledby="plan-cuentas-tab">
                <section class="mb-4">
                    <div class="card">
                        <div class="card-header py-3 d-flex justify-content-center align-items-center position-relative">
                            <h5 class="mb-0"><strong>Plan de Cuentas</strong></h5>
