...
@endsection
@section('modalBody')
    <div class="modal fade" id="ajaxModalAsientos" tabindex="-1" role="dialog" aria-labelledby="ajaxModalCuentas"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ajaxModalCuentas">Registrar Asiento</h5>
                    ...
                    <div class="container-fluid px-3 px-md-5 pt-4">
                        <ul class="nav nav-tabs" id="mainTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="plan-cuentas-tab" data-bs-toggle="tab"
                                    data-bs-target="#plan-cuentas" type="button" role="tab"
                                    aria-controls="plan-cuentas" aria-selected="true"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="plan-cuentas-inactivas-tab" data-bs-toggle="tab"
                                    data-bs-target="#plan-cuentas-inactivas" type="button" role="tab"
                                    aria-controls="otra-seccion" aria-selected="false"
                                    onclick="inicializarDataTableInactivas()">Cuentas Eliminadas</button>
                            </li>
                            <!-- Puedes añadir más solapas aquí -->
                        </ul>
                        <div class="tab-content" id="mainTabsContent">
                            <!-- Contenido de la solapa "Plan de Cuentas" -->
                            <div class="tab-pane fade show active" id="plan-cuentas" role="tabpanel"
