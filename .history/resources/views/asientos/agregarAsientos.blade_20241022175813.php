...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function existeCuenta(nombreCuenta, tipo) {
            const filas = tablaCuentas.getElementsByTagName('tr');
            for (let fila of filas) {
                const celdaCuenta = fila.getElementsByTagName('td')[1]; // Primera celda es la cuenta
                const celdaDebe = fila.getElementsByTagName('td')[2]; // Segunda celda es "Debe"
                const celdaHaber = fila.getElementsByTagName('td')[3]; // Tercera celda es "Haber"
