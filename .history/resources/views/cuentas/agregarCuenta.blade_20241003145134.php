...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function($) {
            $("#catnombre").on("change", function() {
                var nombre = $("#clasificacion").text(); // Obtiene el valor seleccionado del select

                $.ajax({
                    url: '/ruta/del/servidor', // URL del servidor donde se hará la solicitud
                    type: 'GET', // Tipo de solicitud (GET o POST)
