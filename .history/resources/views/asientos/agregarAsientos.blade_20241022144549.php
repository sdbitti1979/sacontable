                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="debeHaber" id="debe" value="Debe" checked>
                                    <label class="form-check-label" for="debe">Debe</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="debeHaber" id="haber" value="Haber">
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="button" class="btn btn-outline-success mt-4" id="agregarCuenta">Agregar cuenta</button>
                            </div>
                        </div>
