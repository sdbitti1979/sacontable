            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $('#detfechaasiento').val(fechaFormateada); // Usamos el primer elemento para los datos generales del asiento
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="detfechaasiento" class="form-label">Fecha</label>
                                <input type="text" id="detfechaasiento" class="form-control" disabled>
                            </div>
                            <div class="col-md-6">
