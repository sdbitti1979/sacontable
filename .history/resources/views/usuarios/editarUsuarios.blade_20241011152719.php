<div class="modal fade" id="ajaxModalUsuarios-edit" tabindex="-1" role="dialog" aria-labelledby="ajaxModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                    onclick="cerrarModal('ajaxModalUsuarios-edit')">Cerrar</button>
