...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function planDeCuentas(){
            $.ajax({
                url: "{{ route('cuentas.cuentasModal') }}?modal=true",
                type: "POST",
                headers: {
                ...
                success: function(response) {
                    ...
                    $('#modalContainerCuentas').html(response);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <button type="button" class="btn btn-outline-info mt-4" onclick="planDeCuentas()">Plan de cuentas</button>
                            </div>
                            <div class="col-md-6">
                                <label for="cuentaSelect" class="form-label">Cuenta</label>
                                <input type="hidden" id="cuentaId" name="cuentaId">
                                <input type="text" id="cuenta" style="position: relative; z-index: 99999;"
                                    name="cuenta" class="form-control" disabled>
                            </div>
                            <div class="col-md-3">
