                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const opciones = response.map(item =>{
                            const selected = item.id_catnombres == nombre_id ? 'selected' : '';
                            return '<option value="' + item.id_catnombres + '" '+selected+'>' + item.nombre + '</option>'
                         });
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" value="{{$datos['nombre']}}" autofocus>
                            <span id="spnombre" style="color:red"></span>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="codigo" class="form-label">Código</label>
                                <input type="text" id="codigo" name="codigo" class="form-control" value="{{$datos['codigo']}}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="clasificacion" id="clasificacion">
                                    ...
                                    @foreach ($clasificaciones as $value => $clasificacion)
                                        <option value="{{ $clasificacion['idclasificacion'] }}" @if($datos['clasificacion_id'] == $clasificacion['idclasificacion']) selected @endif>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" id="saldoActual" name="saldoActual" class="form-control" value="{{$datos['saldo_actual']}}">
                            </div>

                            <div class="col-md-3 mb-3 d-flex align-items-center">
                                <div class="form-check">
                                    <input type="checkbox" id="recibeSaldo" name="recibeSaldo" class="form-check-input" @if($datos['recibe_saldo'] == 'SI') checked='true' @endif>
