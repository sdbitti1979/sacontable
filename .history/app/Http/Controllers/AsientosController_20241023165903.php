...
class AsientosController extends Controller
{
    ...
    public function getAsiento(Request $request)
    {
        ...
        $asiento = DB::table('asientos_contables')
            ...
            ->select('asientos_contables.idasiento', 'to_char(asientos_contables.fecha, "dd/mm/yyyy") as fecha','asientos_contables.descripcion'
                ,'asientos_contables.nro_asiento', 'cuentas.idcuenta', 'cuentas.nombre', 'asiento_cuenta.debe', 'asiento_cuenta.haber')
            ->get();
