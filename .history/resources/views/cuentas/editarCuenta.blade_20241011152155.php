                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" id="codigo" name="codigo" class="form-control"
                                    value="{{ $datos['codigo'] }}" disabled>
                                <span id="spcodigo" style="color:red"></span>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="clasificacion" class="form-label">Clasificación</label>
                                <input type="hidden" id="clasificacion_id" name="clasificacion_id" value="{{ $datos["clasificacion_id"] }}">
                                <input type="text" id="clasificacion" name="clasificacion" class="form-control" value="{{ $datos["clasificacion"] }}" disabled>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" id="saldoActual" name="saldoActual" class="form-control"
                                    value="{{ $datos['saldo_actual'] }}" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="hidden" id="cuentaPadreId" name="cuentaPadreId"
                                    value="{{ $datos['id_padre'] }}">
                                <input type="text" id="cuentaPadre" disabled style="position: relative; z-index: 9999;"
