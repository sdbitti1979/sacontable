    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" data-mdb-collapse-initialized="true">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
                <a href="./dashboard" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init=""
                    aria-current="true">
                    <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Inicio</span>
                </a>
                <a href="./usuarios" class="list-group-item list-group-item-action py-2 active" data-mdb-ripple-init="">
