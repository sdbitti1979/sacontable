    ...
    <script type="text/javascript">
        ...
        function verificarBalance() {
            ...
            for (let fila of filas) {
                const celdaDebe = fila.getElementsByTagName('td')[2].innerText.replace(",", ".");
                const celdaHaber = fila.getElementsByTagName('td')[3].innerText.replace(",", ".");

                totalDebe += parseFloat(celdaDebe) || 0;
                totalHaber += parseFloat(celdaHaber) || 0;
            }
