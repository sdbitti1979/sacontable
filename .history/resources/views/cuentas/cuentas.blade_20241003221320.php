        ...
        $(document).ready(function($) {
            table = $('#cuentas-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'clasificacion_id', name: 'clasificacion_id', orderable: false },
                    { data: 'saldo_actual', name: 'saldo_actual', orderable: false },
                    { data: 'id_padre', name: 'id_padre', orderable: false },
                    { data: 'utilizada', name: 'utilizada', orderable: false },
                    { data: 'eliminada', name: 'eliminada', orderable: false },
                    { data: 'modificado', name: 'modificado', orderable: false },
                    { data: 'usuario', name: 'usuario', orderable: false },
                    { data: 'recibe_saldo', name: 'recibe_saldo', orderable: false }
                ],
                language: {
                    "decimal": "",
