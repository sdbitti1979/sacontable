        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($data)->addIndexColumn()
                ->addColumn('edit', function ($row) {
                    return '<a href="javascript:void(0)" class="edit btn btn-success btn-sm" data-id="' . $row->idpermiso . '">Editar</a>';
                })
                ->orderColumn('idpermiso', 'idpermiso $1')
                ->rawColumns(['edit'])// Establecer el orden por 'idusuario'
                ->make(true);
        }
    }
